...
<template>
  ...
  >
    <div class="size-full justify-end">
      <h1 class="text-(80px/[1] balance) w-600px font-600 tracking-tighter">
        {{ name }}
      </h1>

      <div class="my-4 text-8/[1]">
        Moses Laurence
      </div>
